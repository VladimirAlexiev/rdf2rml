...
- You can use single or triple quotes to surround the content (filter).
- DO NOT use apostrophes to surround the content! But you can use them inside (as in the example above)
