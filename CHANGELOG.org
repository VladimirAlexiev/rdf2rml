#+STARTUP: nonum
** 2026-08-31 rdfpuml: support for named graphs
- For now just partial: https://github.com/VladimirAlexiev/rdf2rml/issues/52
** 2026-07-20 rdf2sparql: prebind vars in multi-agument macros
- Fix https://github.com/VladimirAlexiev/rdf2rml/issues/51
** 2026-07-16 rdf2sparql: support sparql-anywhere (fx)
- See [[https://github.com/VladimirAlexiev/rdf2rml/blob/master/doc/rdf2sparql.md#sparql-anything][rdf2sparql#sparql-anything]]
** 2025-06-22 rdf2sparql: allow templated strings with ~^^~ datatype and ~@~ langTag
** 2025-10-12 rdf2sparql: allow lang tags
- Allow adding lang tag to fields (by using ~strlang()~)
- See [[https://github.com/VladimirAlexiev/rdf2rml/blob/master/doc/rdf2sparql.md#rdf-model-relative-urls-prefixed-urls-language-tags][rdf-model-relative-urls-prefixed-urls-language-tags]]      
** 2025-10-12 rdfpuml: clarify the importance of prefixes.ttl
- See [[https://github.com/VladimirAlexiev/rdf2rml/blob/master/doc/rdfpuml.md#prefixes][prefixes]]
** 2025-07-11 docs: github pages
...
** 2025-01-21 rdf2sparql: interpolate variables in prefixed URLs and strings
