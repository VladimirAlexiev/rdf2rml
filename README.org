...
#+HTML_CONTAINER: div
#+DESCRIPTION:
#+KEYWORDS: RDF, visualization, PlantUML, R2RML, generation, model-driven, RDF by Example, rdfpuml, rdf2rml, rdf2tarql, rdf2ontorefine
...
- *rdf2tarql* generates [[https://tarql.github.io/][TARQL]] transformations from CSV/TSV to RDF that take the form of SPARQL CONSTRUCT
- *rdf2ontorefine* generates OntoRefine transformations from tabular data to direct GraphDB loading in the form of SPARQL UPDATE queries
...
- http://rawgit2.com/VladimirAlexiev/rdf2rml/master/doc/rdf2ontorefine.html

Documentation source:
- [[./doc/rdfpuml.pod]]
- [[./doc/rdf2rml.pod]]
- [[./doc/rdf2tarql.pod]]
- [[./doc/rdf2ontorefine.pod]]
...
** 2018-11-14 Avoid puml:stereotype class node        :VladimirAlexiev:
...
** 2018-06-29 Bug: class and puml:InlineProperty      :VladimirAlexiev:
...
** 2018-04-05 Arrow Attributes                        :VladimirAlexiev:
Add arrow attributes (dotted, dashed, bold) and length

Test: [[./test/regression/arrowLen.ttl]]


** 2020-05-30 rdf2rml: inverse edge                   :VladimirAlexiev:
...
** 2020-06-01 rdf2tarql.pl                            :VladimirAlexiev:
Add rdf2tarql.pl script to generate TARQL script (CSV-RDF conversion) from model.

** 2020-06-01 rdf2rml.sh, rdf2rml.ru                  :VladimirAlexiev:
...
** 2020-09-17 rdf2rml: logicalTable                   :VladimirAlexiev:
